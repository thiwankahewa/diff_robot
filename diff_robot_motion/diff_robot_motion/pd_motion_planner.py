...
class PDMotionPlanner(Node):
    def __init__(self):
        ...
        self.declare_parameter("step_size", 0.2)   #resolution of the path/map
        ...
        self.next_pose_pub = self.create_publisher(PoseStamped, "/pd/next_pose", 10)   #debugging purpose

        # Control loop
        self.timer = self.create_timer(0.1, self.control_loop)   #pid control loop
