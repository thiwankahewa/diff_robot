...
class SimpleController(Node):
    ...
    def __init__(self):
        ...
        self.odom_pub_ = self.create_publisher(Odometry, "diff_robot_controller/odom", 10)
    ...
    def jointStateCallback(self, msg):
        ...
        self.br_.sendTransform(self.transform_stamped_)          # Broadcast the transform over tf to /tf topic
